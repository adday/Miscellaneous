...
public class Equation {
	...
	public Symbol line(BST symbolTable) throws BSTException, ParseException{
		...
		if(nextToken == null)
			...
			result = exprTree.postorderEval(root, "", symbolTable);// evaluate expr tree
			lhsVal = new Symbol(lhs, result);//create symbol
			symbolTable.insertItem(lhsVal);//insert symbol into symbolTable
			if(debug)
